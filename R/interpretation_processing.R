...
# PAUL replaced this with the standard "integrate" because of errors with the pracma version that I'm not getting with this one, maybe because there's a regular integrate() inside. Error is "Error in integrate(.fntointegrate, lower = shift.low, upper = shift.high,  :   the integral is probably divergent"
#   total_aoc <- pracma::integral(fun = fun,
#                                 xmin = range_start,
#                                 xmax = range_end,
#                                 no_intervals = 1000)
  total_aoc <- integrate( f = fun, lower = range_start, upper = range_end )[[1]]
